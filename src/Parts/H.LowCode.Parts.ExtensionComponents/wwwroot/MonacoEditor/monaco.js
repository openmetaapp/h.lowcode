export function initMonacoEditor(containerId, code, language, theme) {
    const loaderUrl = "_content/H.LowCode.Parts.ExtensionComponents/MonacoEditor/loader.min.js";

    loadScript(loaderUrl, function () {
        //如果cdn加载速度较快的话,更推荐使用cdn
        require.config({ paths: { 'vs': 'https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.30.1/min/vs' } });
        //require.config({ paths: { 'vs': '_content/H.LowCode.Parts.ExtensionComponents/MonacoEditor' } });
